"""
Remove background from triangle_enemy.png, crop tight, write RGBA to assets/.
Run: uv run --with pillow python3 tests/prepare_triangle_enemy_asset.py
"""
...
INPUT   = ROOT / "assets" / "triangle_enemy.png"
OUTPUT  = ROOT / "assets" / "triangle_enemy.png"
PREVIEW = ROOT / "tests" / "generated_transparent_assets" / "triangle_enemy_preview_dark.png"
