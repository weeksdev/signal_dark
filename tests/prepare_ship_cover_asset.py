"""
Remove background from ship_with_cover.png, crop tight, write RGBA to assets/.
Run: uv run --with pillow python3 tests/prepare_ship_cover_asset.py
"""
...
INPUT   = ROOT / "assets" / "ship_with_cover.png"
OUTPUT  = ROOT / "assets" / "ship_with_cover.png"
PREVIEW = ROOT / "tests" / "generated_transparent_assets" / "ship_with_cover_preview_dark.png"
