"""
Remove background from prism.png, crop tight, write RGBA to assets/.
Run: uv run --with pillow python3 tests/prepare_prism_asset.py
"""
...
INPUT   = ROOT / "assets" / "prism.png"
OUTPUT  = ROOT / "assets" / "prism.png"
PREVIEW = ROOT / "tests" / "generated_transparent_assets" / "prism_preview_dark.png"
