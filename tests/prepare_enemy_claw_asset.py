"""
Remove background from enemy_claw.png, crop tight, write RGBA to assets/.
Run: uv run --with pillow python3 tests/prepare_enemy_claw_asset.py
"""
...
INPUT   = ROOT / "assets" / "enemy_claw.png"
OUTPUT  = ROOT / "assets" / "enemy_claw.png"
PREVIEW = ROOT / "tests" / "generated_transparent_assets" / "enemy_claw_preview_dark.png"
