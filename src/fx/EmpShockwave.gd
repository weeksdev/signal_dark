...
func _draw() -> void:
	...
	draw_arc(Vector2.ZERO, ring_radius, 0.0, TAU, 96, Color(cyan.r, cyan.g, cyan.b, 0.85 * fade), 4.0)
	draw_arc(Vector2.ZERO, ring_radius * 0.82, 0.0, TAU, 80, Color(white.r, white.g, white.b, 0.28 * fade), 1.6)
	draw_arc(Vector2.ZERO, ring_radius * 1.06, 0.0, TAU, 96, Color(0.02, 0.06, 0.07, 0.36 * fade), 5.0)
	...
	for i in range(5):
		...
		draw_line(start2, end2, Color(error.r, error.g, error.b, 0.42 * fade), 1.1)
