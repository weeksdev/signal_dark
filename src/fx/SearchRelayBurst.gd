...
const PULSE_TRAIL_THICKNESS := 2.5
...
func _draw() -> void:
	...
	draw_arc(from_point, pulse_radius, 0.0, TAU, 64, pulse_color, 1.8)
	draw_arc(from_point, maxf(0.0, pulse_radius - 10.0), 0.0, TAU, 56, Color(hot_color.r, hot_color.g, hot_color.b, 0.44 * pulse_alpha), 0.7)
	...
	draw_arc(to_point, TAG_FLASH_RADIUS + 12.0 * hit_t, 0.0, TAU, 28, tag_color, 1.2)
	draw_arc(to_point, TAG_FLASH_RADIUS * 0.55 + 6.0 * hit_t, 0.0, TAU, 22, tag_hot, 0.6)
	draw_line(to_point + Vector2(-8.0, 0.0), to_point + Vector2(8.0, 0.0), Color(tag_color.r, tag_color.g, tag_color.b, 0.72 * hit_alpha), 0.9)
	draw_line(to_point + Vector2(0.0, -8.0), to_point + Vector2(0.0, 8.0), Color(tag_color.r, tag_color.g, tag_color.b, 0.72 * hit_alpha), 0.9)
